  ...
  return (
    <main className="min-h-screen bg-[#0b0d12] text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <SectionHeading
          eyebrow="Credibility"
          title="Built with real deck contractor workflows in mind"
          description="DeckMargin is focused on helping deck builders quote faster, standardize pricing, and protect profit on every job."
        />
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {proofBullets.map((item) => (
            <div
              ...
              className="rounded-3xl border border-white/10 bg-white/[0.03] p-7"
            >
              <div className="mb-4 h-10 w-10 rounded-2xl bg-blue-400/15 ring-1 ring-blue-400/20" />
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <div className="mx-auto max-w-xl">
            <div className="rounded-[28px] border border-blue-400/20 bg-gradient-to-b from-blue-500/12 to-white/[0.03] p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
              ...
              <div className="text-4xl font-semibold text-white">$100<span className="text-lg text-gray-400">/month</span></div>
