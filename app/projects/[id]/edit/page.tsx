          ...
          {!isRepair && !isRailingOnly && (
            <>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  <FieldLabel label="Material Type" help="Main decking material — sets the per-SF material rate. Configure rates in Settings → Pricing." />
              ...
              {allPhases.length > 0 && (
                <div className="mt-2 rounded-lg border border-white/10 bg-[#0b1220] p-3">
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <FieldHelp text="These are productivity estimates only. They show how on-site hours might be distributed across phases. They do NOT determine the quoted labor cost — that is calculated separately above." />
